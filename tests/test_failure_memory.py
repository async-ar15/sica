...
@pytest.fixture
def failure_memory(db_path: str, mock_provider: MagicMock):
...
def test_init_creates_collection(failure_memory: FailureMemory):
...
def test_init_no_chromadb(db_path: str, mock_provider: MagicMock):
...
def test_record_and_search_failure(failure_memory: FailureMemory, mock_provider: MagicMock):
...
def test_search_respects_threshold(failure_memory: FailureMemory, mock_provider: MagicMock):
...
def test_provider_disabled_fallback(failure_memory: FailureMemory, mock_provider: MagicMock):
